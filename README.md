# Voting DApp with ERC20 tokens 

A simple example of a decentralized organization in which token holders can directly participate in governance through voting. The weight of the vote is determined by the share of ownership - the number of purchased tokens.
...
You can interact with your smart contract using the `Debug Contracts` page. 
